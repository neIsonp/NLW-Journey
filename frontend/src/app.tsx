...
export function App() {
  ...
  const [isGuestsModaltOpen, setIsGuestsModaltOpen] = useState(false);
  ...
  function openGuestsModal() {
    setIsGuestsModaltOpen(true);
  }
  function closeGuestsModal() {
    setIsGuestsModaltOpen(false);
  }
  ...
  function removeEmaiFromInvites(emailToRemove: string) {
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              >
                ...
                <span className="bg-transparent text-zinc-400 text-lg outline-none">
                  ...
                  >
                    ...
                    <button type="button">
                      <X
                        ...
                        onClick={() => removeEmaiFromInvites(email)}
                      />
                    </button>
                  </div>
                );
